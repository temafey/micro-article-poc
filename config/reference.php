 ...
 *     },
 *     event_store?: scalar|null|Param, // a service definition id implementing Broadway\EventStore\EventStore
 *     saga?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         state_repository?: scalar|null|Param, // a service definition id implementing Broadway\Saga\State\RepositoryInterface
 *     },
 *     serializer?: array{
 *         payload?: scalar|null|Param, // Default: "broadway.simple_interface_serializer"
 *         readmodel?: scalar|null|Param, // Default: "broadway.simple_interface_serializer"
 *         metadata?: scalar|null|Param, // Default: "broadway.simple_interface_serializer"
 *     },
 *     read_model?: scalar|null|Param, // a service definition id implementing Broadway\ReadModel\RepositoryFactory
 * }
 ...
 *         middleware?: array<string, scalar|null|Param>,
 *         method_inflector?: scalar|null|Param,
 *     }>,
 *     default_bus?: scalar|null|Param, // Default: "default"
 *     method_inflector?: scalar|null|Param, // Default: "tactician.handler.method_name_inflector.handle"
 *     security?: array<string, list<scalar|null|Param>>,
 *     logger_formatter?: scalar|null|Param, // Default: "tactician.logger.class_properties_formatter"
 * }
 * @psalm-type SagaBundleConfig = array<mixed>
 ...
 *             dsn: scalar|null|Param, // The MQ broker DSN. These schemes are supported: "file", "amqp", "amqps", "db2", "ibm-db2", "mssql", "sqlsrv", "mysql", "mysql2", "pgsql", "postgres", "sqlite", "sqlite3", "null", "gearman", "beanstalk", "kafka", "rdkafka", "redis", "rediss", "stomp", "sqs", "sns", "snsqs", "gps", "mongodb", "wamp", "ws", to use these "file", "amqp", "null" you have to install a package.
 *             connection_factory_class?: scalar|null|Param, // The connection factory class should implement "Interop\Queue\ConnectionFactory" interface
 *             factory_service?: scalar|null|Param, // The factory class should implement "Enqueue\ConnectionFactoryFactoryInterface" interface
 *             factory_class?: scalar|null|Param, // The factory service should be a class that implements "Enqueue\ConnectionFactoryFactoryInterface" interface
 *             ...<mixed>
 *         },
 *         consumption?: array{
 ...
 *             prefix?: scalar|null|Param, // Default: "enqueue"
 *             separator?: scalar|null|Param, // Default: "."
 *             app_name?: scalar|null|Param, // Default: "app"
 *             router_topic?: scalar|null|Param, // Default: "default"
 *             router_queue?: scalar|null|Param, // Default: "default"
 *             router_processor?: scalar|null|Param, // Default: null
 *             redelivered_delay_time?: int|Param, // Default: 0
 *             default_queue?: scalar|null|Param, // Default: "default"
 *             driver_options?: array<mixed>,
 *         },
 *         monitoring?: array<mixed>,
 *         async_commands?: array<mixed>,
 *         job?: bool|array{
 *             default_mapping?: bool|Param, // Adds bundle's default Job entity mapping to application's entity manager // Default: true
 *             enabled?: bool|Param, // Default: false
 *         },
 ...
 *         },
 *     }>
 * @psalm-type TaskBundleConfig = array<mixed>
 * @psalm-type MicroFaultToleranceConfig = array{
 *     enqueue?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         retryTimeout?: int|Param, // Default: 1000000
 *         retryAttemps?: int|Param, // Default: 3
 *         clients?: list<scalar|null|Param>,
 *     },
 *     alerting?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         retryTimeout?: int|Param, // Default: 1000000
 ...
 *     kernel_reboot?: array{
 *         strategy?: list<scalar|null|Param>,
 *         allowed_exceptions?: list<scalar|null|Param>,
 *         max_jobs?: scalar|null|Param, // Only used when `reboot_kernel.strategy: max_jobs`. Maximum numbers of jobs before kernel reboot // Default: 1000
 *         max_jobs_dispersion?: scalar|null|Param, // Only used when `reboot_kernel.strategy: max_jobs`. Dispersion persent // Default: 0.2
 *         memory_threshold_mb?: scalar|null|Param, // Only used when `reboot_kernel.strategy: memory`. Memory threshold in megabytes // Default: 128
 *     },
 *     middlewares?: list<scalar|null|Param>,
 *     interceptors?: list<scalar|null|Param>,
 *     default_integrations?: bool|Param, // Default: true
 *     metrics?: array{
 *         enabled?: bool|Param, // Default: false
 *         collect?: list<array{ // Default: []
 *             type: "counter"|"histogram"|"gauge"|"summary"|Param,
 *             help?: scalar|null|Param, // Default: null
 *             namespace?: scalar|null|Param, // Default: null
 *             subsystem?: scalar|null|Param, // Default: null
 *             labels?: list<scalar|null|Param>,
 ...
 *     task_bundle?: TaskBundleConfig,
 *     micro_fault_tolerance?: MicroFaultToleranceConfig,
 ...
 *     "when@frankenphp"?: array<string, RouteConfig|ImportConfig|AliasConfig>,
