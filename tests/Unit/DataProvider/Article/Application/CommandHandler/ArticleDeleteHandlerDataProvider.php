...
/**
 * DataProvider for ArticleDeleteHandler tests.
 *
 * Uses mockArgs/mockTimes pattern for mock configuration.
 *
 * @see \Tests\Unit\Article\Application\CommandHandler\ArticleDeleteHandlerTest
 */
final class ArticleDeleteHandlerDataProvider
{
    /**
    ...
    {
        yield 'standard article deletion' => [
            'mockArgs' => [
        ...
        yield 'deletion with different uuid' => [
            'mockArgs' => [
    ...
    public static function provideFailureScenarios(): iterable
    {
        ...
        yield 'repository store failure' => [
            'mockArgs' => [
                ...
                'storeExceptionMessage' => 'Failed to delete entity',
            ],
            'mockTimes' => [
                'get' => 1,
                'articleDelete' => 1,
            ...
            'expectedException' => \RuntimeException::class,
            'expectedMessage' => 'Failed to delete entity',
        ];
    }
}
