...
/**
 * DataProvider for ArticleArchiveHandler tests.
 *
 * Uses mockArgs/mockTimes pattern for mock configuration.
 *
 * @see \Tests\Unit\Article\Application\CommandHandler\ArticleArchiveHandlerTest
 */
final class ArticleArchiveHandlerDataProvider
{
    /**
    ...
    {
        yield 'standard article archival' => [
            'mockArgs' => [
        ...
        yield 'archival with different uuid' => [
            'mockArgs' => [
    ...
    public static function provideFailureScenarios(): iterable
    {
        ...
        yield 'repository store failure' => [
            'mockArgs' => [
                ...
                'storeExceptionMessage' => 'Failed to archive entity',
            ],
            'mockTimes' => [
                'get' => 1,
                'articleArchive' => 1,
            ...
            'expectedException' => \RuntimeException::class,
            'expectedMessage' => 'Failed to archive entity',
        ];
    }
}
