...
/**
 * DataProvider for ArticlePublishHandler tests.
 *
 * Uses mockArgs/mockTimes pattern for mock configuration.
 *
 * @see \Tests\Unit\Article\Application\CommandHandler\ArticlePublishHandlerTest
 */
final class ArticlePublishHandlerDataProvider
{
    /**
    ...
    {
        yield 'standard article publication' => [
            'mockArgs' => [
        ...
        yield 'publication with different uuid' => [
            'mockArgs' => [
    ...
    public static function provideFailureScenarios(): iterable
    {
        ...
        yield 'repository store failure' => [
            'mockArgs' => [
                ...
                'storeExceptionMessage' => 'Failed to publish entity',
            ],
            'mockTimes' => [
                'get' => 1,
                'articlePublish' => 1,
            ...
            'expectedException' => \RuntimeException::class,
            'expectedMessage' => 'Failed to publish entity',
        ];
    }
}
