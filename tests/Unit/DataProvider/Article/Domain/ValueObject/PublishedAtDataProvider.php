...
/**
 * DataProvider for PublishedAt ValueObject tests.
 *
 * @see \Tests\Unit\Article\Domain\ValueObject\PublishedAtTest
 */
final class PublishedAtDataProvider
{
    /**
    ...
    public static function provideValidDateStrings(): iterable
    {
        ...
        yield 'future date' => [
            ...
            'expectedFormat' => '2030-12-31 23:59:59',
        ];
