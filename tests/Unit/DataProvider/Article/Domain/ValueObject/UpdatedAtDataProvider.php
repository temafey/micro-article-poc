...
/**
 * DataProvider for UpdatedAt ValueObject tests.
 *
 * @see \Tests\Unit\Article\Domain\ValueObject\UpdatedAtTest
 */
final class UpdatedAtDataProvider
{
    /**
    ...
    public static function provideValidDateStrings(): iterable
    {
        ...
        yield 'recent update' => [
            'value' => '2024-06-15 14:22:11',
            'expectedFormat' => '2024-06-15 14:22:11',
        ];

        yield 'update after creation' => [
            'value' => '2024-01-15 12:00:00',
            'expectedFormat' => '2024-01-15 12:00:00',
        ];

        yield 'last modification' => [
            'value' => '2024-12-31 23:59:59',
            'expectedFormat' => '2024-12-31 23:59:59',
        ];

        yield 'immediate update' => [
