...
/**
 * DataProvider for CategoryId ValueObject tests.
 *
 * @see \Tests\Unit\Article\Domain\ValueObject\CategoryIdTest
 */
final class CategoryIdDataProvider
{
    /**
    ...
    public static function provideValidUuids(): iterable
    {
        ...
        yield 'category specific uuid' => [
            'value' => 'c47e9400-a19b-41d4-b716-446655440001',
            'expected' => 'c47e9400-a19b-41d4-b716-446655440001',
        ];
    }
