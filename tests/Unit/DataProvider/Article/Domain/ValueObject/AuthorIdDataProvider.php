...
/**
 * DataProvider for AuthorId ValueObject tests.
 *
 * @see \Tests\Unit\Article\Domain\ValueObject\AuthorIdTest
 */
final class AuthorIdDataProvider
{
    /**
    ...
    public static function provideValidUuids(): iterable
    {
        ...
        yield 'author specific uuid' => [
            'value' => 'a47e9400-b19b-41d4-c716-446655440002',
            'expected' => 'a47e9400-b19b-41d4-c716-446655440002',
        ];
    }
