...
use Tests\Unit\DataProvider\Article\Application\Command\ArticleUnpublishCommandDataProvider;

/**
 * Unit tests for ArticleUnpublishCommand.
 */
#[CoversClass(ArticleUnpublishCommand::class)]
final class ArticleUnpublishCommandTest extends TestCase
{
    #[Test]
    #[DataProviderExternal(ArticleUnpublishCommandDataProvider::class, 'provideValidConstructionData')]
    public function constructWithValidDataShouldCreateInstance(string $processUuid, string $uuid): void
    {
        ...
        // Act
        $command = new ArticleUnpublishCommand($processUuidVo, $uuidVo);
    ...
    #[Test]
    #[DataProviderExternal(ArticleUnpublishCommandDataProvider::class, 'provideWithPayloadScenarios')]
    public function constructWithPayloadShouldIncludePayload(
        ...
        // Act
        $command = new ArticleUnpublishCommand($processUuidVo, $uuidVo, $payloadVo);
    ...
    public function getProcessUuidShouldReturnCorrectValue(): void
    {
        ...
        // Act
        $command = new ArticleUnpublishCommand($processUuid, $uuid);
