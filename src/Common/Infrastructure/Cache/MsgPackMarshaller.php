...
{
    /**
     * Marshalls (serializes) values using MsgPack binary format.
     *
    ...
    /**
     * Unmarshalls (deserializes) a MsgPack binary string back to its original value.
     *
     * @param string $value The MsgPack serialized string
     *
