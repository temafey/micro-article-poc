...
final class DbalOutboxRepository implements OutboxRepositoryInterface
{
    ...
    private const SEQUENCE_NAME = 'outbox_sequence_seq';
    ...
    public function save(OutboxEntryInterface $entry): void
    {
        try {
            ...
            throw OutboxPersistenceException::saveFailed($entry->getId(), $e);
        }
    }
    ...
    public function saveAll(array $entries): void
    {
        ...
        try {
            ...
            throw OutboxPersistenceException::batchSaveFailed(count($entries), $e);
        }
    }
    ...
    public function findUnpublished(int $limit): array
    {
        ...
        return array_map(
            static fn (array $row): OutboxEntryInterface => OutboxEntry::fromArray($row),
    ...
    public function markAsPublished(array $ids, DateTimeImmutable $publishedAt): int
    {
        ...
        $params = array_merge(
            [$publishedAt->format('Y-m-d H:i:s.u')],
            $ids
        );
    ...
    public function markAsFailed(string $id, string $error, DateTimeImmutable $nextRetryAt): void
    {
        try {
            ...
            throw OutboxPersistenceException::updateFailed($id, $e);
        }
    }
