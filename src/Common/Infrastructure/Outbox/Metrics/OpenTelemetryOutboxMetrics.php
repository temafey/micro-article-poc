...
{
    private const METER_SCOPE = 'outbox';
    ...
    public function recordMessagePublished(OutboxMessageType $type, float $durationSeconds): void
    {
        ...
        $this->publishDurationHistogram->record($durationSeconds * 1000, [ // Convert to milliseconds
            'message_type' => $type->value,
        ]);
    }
    ...
    public function recordCleanup(int $deletedCount, float $durationSeconds): void
    {
        ...
        $this->cleanupDurationHistogram->record($durationSeconds * 1000, [ // Convert to milliseconds
    ...
    private function initializeMetrics(): void
    {
        ...
        // Histograms with appropriate buckets for milliseconds
        ...
        $meter->createObservableGauge(
            ...
            function (ObserverInterface $observer): void {
                foreach ($this->pendingCounts as $messageType => $count) {
                    $observer->observe($count, ['message_type' => $messageType]);
                }
            }
        );
    }
