...
namespace Micro\Component\Common\Presentation\Rest\Traits;

use Micro\Component\Common\Infrastructure\Filter\JsonPathFilterInterface;
 ...
 *
 * Usage:
 * GET /api/v1/article?filter=$.items[?(@.status == "published")]
 * GET /api/v1/article?filter=$[?(@.publishedAt > "2024-01-01")]
 * GET /api/v1/article?filter=$..title
 *
 * The filter parameter accepts any valid JSONPath expression and applies
 * it to the response data before returning.
 */
